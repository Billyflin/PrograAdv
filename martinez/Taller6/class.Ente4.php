...
class Ente
{
    ...
    private $deltay;
    private $colorActual;
    private $colores = ["sano" => "#33AA44", "contagiado" => "#AA3344", "inmune" => "#A333AA", "muerto" => "#2473AA"];
    private $radio;

    private $estadoActual;
    private $estados = ["s" => "sano", "c" => "contagiado", "i" => "inmune", "m" => "muerto"];
    ...
    function __construct($pos_x, $pos_y, $velocidad_x, $velocidad_y, $estado, $ciclosContagio)
    {
        ...
        $this->sentenciado = false;
    }

    function fijarSentenciado() {

        if($this->estaContagiado() && !$this->asintomatico){
            $this->ciclosContagio = intval($this->ciclosContagio/2);
            $this->sentenciado = true;
        }
    }
    ...
    function fijarColor($estado)
    {
        $this->colorActual = $this->colores[$estado];
    }

    function estaSentenciado()
    {
    ...
    function fijarEstado($estado)
    {
        ...
        $this->fijarColor($this->estadoActual);
    }
